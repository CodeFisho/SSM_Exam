	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'examId',title:'所属学科',width:160,formatter:function(value,index,row){
			...
			{ field:'status',title:'状态',width:160,formatter:function(value,index,row){
				if(value==0) return '未考';
				return '已考';
			}},
			{ field:'startExamTime',title:'开考时间',width:200,formatter:function(value,index,row){
				if(value=='' || value==null) return '';
				return format(value);
			}},
			{ field:'endExamTime',title:'交卷时间',width:200,formatter:function(value,index,row){
				if(value=='' || value==null) return '';
				return format(value);
			}},
			{ field:'useTime',title:'用时',width:100,sortable:true},
			{ field:'totalScore',title:'总分',width:100,sortable:true},
			{ field:'score',title:'得分',width:100,sortable:true},
