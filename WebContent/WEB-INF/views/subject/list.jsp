	...
	<form id="add-form" method="post">
        <table>
        	<tr>
                ...
                <td><input  type="text" id="add-content" name="name"  class="wu-text easyui-validatebox" data-options="required:true,missingMessage:'请填写学科名称'" ></input></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
        	<tr>
                <td align="right">学科名称:</td>
                <td><input  type="text" id="edit-name" name="name"  class="wu-text easyui-validatebox" data-options="required:true,missingMessage:'请填写学科名称'" ></input></td>
            </tr>
            <tr>
                <td align="right">学科备注:</td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'remark',title:'学科信息备注',width:100,sortable:true}
		]]		
	});
</script>