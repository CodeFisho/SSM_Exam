        	...
        	<table width="100%" cellpadding="5" border="0" class="tm_table_form">
            	<tbody>
					...
					<tr>
                        <th>旧密码 : </th>
                        <td>
							<input type="password" name="old_password" name="old_password" id="old_password" class="validate[required] tm_txt" size="50" maxlength="30" />
					...
					<tr>
						<th>确认新密码 : </th>
						<td>
							<input type="password" class="validate[required,equals[new_password]] tm_txt" id="new_password2" name="new_password2" size="50" maxlength="30" value="" />
							<span class="tm_required">*</span>
						</td>
					</tr>
			...
			doUpdate : function(){
				...
				if(formcheck){
					...
					$.ajax({
						...
						url: "updatePassword",
						dataType:'json',
						data:{oldPassword:$("#old_password").val(),newPassword:$("#new_password").val(),passAgain:$("#new_password2").val()},
