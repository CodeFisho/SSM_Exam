...
<link href="../../resources/exam/css/main.css" rel="stylesheet" type="text/css" />
<link href="../../resources/exam/css/iconfont.css" rel="stylesheet" type="text/css" />
<link href="../../resources/exam/css/test.css" rel="stylesheet" type="text/css" />
<style>
.hasBeenAnswer {
	background: #5d9cec;
	color:#fff;
			...
			<div class="test">
				...
				<form action="" method="post">
					<div class="test_title">
						...
						<font ><input type="button" style="background-color:#555" disabled="disabled" name="test_jiaojuan"  value="交卷"></font>
					</div>
									...
									<li id="qu_${singleQuestion }_${sq.question.id}" data-key="${sq.id}">
										...
										<div class="test_content_nr_main">
											<ul>
													...
													<li class="option" data-type="single" data-value="D">
															<lable style="color:red;">正确答案:${sq.question.answer}</lable>
													</li>
											</ul>
										</div>
									</li>
									...
									<li id="qu_${muiltQuestion }_${mq.question.id}" data-key="${mq.id}">
										...
										<div class="test_content_nr_main">
											<ul>
													...
													<li class="option" data-type="single" data-value="D">
															<lable style="color:red;">正确答案:${mq.question.answer}</lable>
													</li>
											</ul>
										</div>
									</li>
									...
									<li id="qu_${chargeQuestion }_${cq.question.id}" data-key="${cq.id}">
										...
										<div class="test_content_nr_main">
											<ul>
													...
													<li class="option" data-type="single" data-value="D">
															<lable style="color:red;">正确答案:${cq.question.answer}</lable>
													</li>
											</ul>
										</div>
									</li>
			...
			<div class="nr_rt_main">
				<div class="rt_nr1">
					<div class="rt_nr1_title">
						...
						<p class="test_time">
							<img style="float:left;margin-top:15px;margin-left:10px;" src="../../resources/exam/images/time.png" width="16px">
							<b class="alt-1">${exam.avaliableTime}</b>
						</p>
					</div>
					<c:if test="${exam.singleQuestionNum !=0 }">
...
<script src="../../resources/exam/js/jquery-1.11.3.min.js"></script>
<script src="../../resources/exam/js/jquery.easy-pie-chart.js"></script>
<!--时间js-->
<script src="../../resources/exam/js/jquery.countdown.js"></script>
<script>
	...
	$(function() {
		$('li.option input').click(function() {
			...
			if($(this).attr("date-type")=='muilt'){
				selectedAnswer='';
				var checkBox=$(this).closest('li.option').parent("ul").find("input[type='checkbox']:checked");
			...
			$.ajax({
				...
				type:'post',
				dataType:'json',
				data:{examId:submitExamId,questionId:questionId,examPaperId:examPaperId,answer:selectedAnswer,id:examPaperAnswerId},
