			...
			<div class="test">
				<form action="" method="post">
					<div class="test_title">
						<p class="test_time">
							<b class="alt-1">${hour}:${minute}:${second}</b>
						</p>
						<font><input type="button" name="test_jiaojuan" onclick="submitExam()" value="交卷"></font>
					</div>
...
<script>
	...
	function autoSubmitExam(){
		...
		var examPaperId=${examPaper.id};
		$.ajax({
			url:'submit_exampaper',
			type:'post',
			dataType:'json',
			data:{examId:submitExamId,examPaperId:examPaperId},
			success:function(data){
				if(data.type=='success'){
					alert('考时间到，强制提交');
