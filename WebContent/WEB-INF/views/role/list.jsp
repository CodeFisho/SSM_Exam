...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>角色名称：</label><input  id="serach-name" class="wu-text easyui-text" style="width:100px">
...
<script type="text/javascript">
	...
	*/
	...
	function havaParent(rows,parentId){
	...
	function isAdded(row,rows){
		for(var k=0;k<existAuthority.length;k++){
			if(existAuthority[k].menuId ==row.id && havaParent(rows,row.parentId)){
				return true;
			} 
		}
		return false;
                ...
                handler: function(){
                	...
                	if(ids != ''){
                		...
                		$.ajax({
                			...
                			success:function(data){
                				if(data.type == 'success'){
                					$.messager.alert('信息提示','权限编辑成功，重新登登录后生效！','info');
